...
plt.show()
# plt.figure()
# plt.plot([i for i in range(len(losses))],losses,color = 'green',alpha = 0.6)
# ax = plt.gca()
# ax.set_facecolor('#D9E6E8')
# plt.title("Stochastic Gradient Descent-(%i,%i) =(Epochs,Batchsize)"%(args.epochs,args.batch_size))
# plt.xlabel("Epoch")
# plt.ylabel("BSE Loss")
# plt.grid('on')
# plt.show()
